      ...
      <main className="max-w-3xl w-full md:w-2/3 space-y-8">
        ...
        <section className="bg-blue-100 dark:bg-blue-900 p-6 rounded-lg">
          ...
          <p className="text-gray-800 dark:text-gray-200">
            Hey there! I’m Mohammad Reza — a developer who loves learning new things.
            This is where I write about my journey — from backend to frontend, from ideas to mistakes.
            If you’re into real learning (and a few hiccups along the way), welcome aboard!
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300">
            ...
            After teaching English for a while, I decided to dive deeper into the world of code — from APIs and databases to frontend and deployment.
            This blog is where I share what I learn, what I build, and sometimes what completely breaks along the way 😅
            I believe learning should be fun, honest, and shared — so if you’re curious about tech, growth, and the messy process of figuring things out, you’re in the right place.
          </p>
        </section>
